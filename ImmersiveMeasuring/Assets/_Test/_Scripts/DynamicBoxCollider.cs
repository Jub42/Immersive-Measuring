...
public class DynamicBoxCollider : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Set all the sliders max values to 20 so the size values don't goDataCube above 20
        m_SliderX.maxValue = 20;
        m_SliderY.maxValue = 20;
        m_SliderZ.maxValue = 20;

        //Set all the sliders min values to 1 so the size don't goDataCube below 1
